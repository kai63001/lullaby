...
var ProfileController = /** @class */ (function () {
    ...
    ProfileController.prototype.initializeRoutes = function () {
        this.router.get("/profile", auth_ext_1.default, this.getMyProfile);
    };
    ProfileController.prototype.getMyProfile = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var usertoken, decoded, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        console.log(decoded);
                        return [4 /*yield*/, Users.aggregate([
